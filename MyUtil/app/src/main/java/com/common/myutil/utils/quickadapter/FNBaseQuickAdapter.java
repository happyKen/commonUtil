 ...
 */
public abstract class FNBaseQuickAdapter<T, H extends FNBaseAdapterHelper> extends BaseAdapter {

    protected static final String TAG = FNBaseQuickAdapter.class.getSimpleName();

    protected final Context context;
    protected final List<T> data;
    protected int layoutResId;
    protected boolean displayIndeterminateProgress = false;
    protected FNMultiItemTypeSupport<T> mMultiItemSupport;
     ...
     */
    public FNBaseQuickAdapter(Context context, int layoutResId) {
     ...
     */
    public FNBaseQuickAdapter(Context context, int layoutResId, List<T> data) {
        this.data = data == null ? new ArrayList<T>() : new ArrayList<T>(data);
        this.context = context;
        this.layoutResId = layoutResId;
    }

    public FNBaseQuickAdapter(Context context, ArrayList<T> data, FNMultiItemTypeSupport<T> multiItemSupport) {
    ...
    public int getViewTypeCount() {
        if (mMultiItemSupport != null)
            return displayIndeterminateProgress ? mMultiItemSupport.getViewTypeCount() + 1
                    : mMultiItemSupport.getViewTypeCount();
        return displayIndeterminateProgress ? 2 : 1;
    }
