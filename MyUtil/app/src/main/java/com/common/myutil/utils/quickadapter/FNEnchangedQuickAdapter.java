...
public abstract class FNEnchangedQuickAdapter<T> extends FNQuickAdapter<T> {
     ...
     */
    public FNEnchangedQuickAdapter(Context context, int layoutResId) {
     ...
     */
    public FNEnchangedQuickAdapter(Context context, int layoutResId, List<T> data) {
        super(context, layoutResId, data);
    }

    @Override
    protected final void convert(FNBaseAdapterHelper helper, T item) {
     ...
     */
    protected abstract void convert(FNBaseAdapterHelper helper, T item, boolean itemChanged);
}
